...
var dLoc = {'x':252, 'y':520},
    ...
    helpTxt = new Text({x:252,y:550},'Arrows to Play/Select & Enter to Confirm');

// Place all enemy objects in an array called allEnemies
var allEnemies = [],
    eLoc = {x:0,y:0}, //Origin holder
    eFrame ={topX : 3, topY : 78, width : 96, height : 64}, //Frame for the center of mass
...
var allTreasures =[],
    tLoc = {x:0,y:0},
    tFrame = {topX : 4, topY : 58, width : 94, height : 104},
    tSprite = [
...
var tileW = 101,
    tileH = 83,
    pOrigColRow = {x : 2, y : 4},
    pOrigin = {x:pOrigColRow.x*tileW, y:pOrigColRow.y*tileH},
    pFrame = {topX : 16, topY : 63, width : 64, height : 74},
