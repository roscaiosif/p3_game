...
var Engine = (function(global) {
    ...
    var gameOver = new Text({x:canvas.width/2,y:canvas.height/2},'Game Over!'),
        livesTxt = new Text({x:455,y:90},''),
        scoreTxt = new Text({x:10,y:80},'');
    ...
    function updateEntities(dt) {
        ...
        var lt =allTreasures.length,n; //add treasures after 500 cycles or when they were collected
        if ( lt== 0){
            counter++;
         };
         if (counter>500 && lt < 3) {
